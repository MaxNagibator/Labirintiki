...
public class Bomb : Item
{
    ...
    public override string Description => $"""
                                           Бомба - это ваш верный спутник в этом запутанном лабиринте. 
                                           Она не просто взрывается, а танцует танец разрушения, сокрушая стены и открывая новые пути. 
                                           Представьте себе, как эта маленькая сфера грациозно порхает по коридорам, оставляя за собой шлейф из обломков и пыли. 
                                           Когда вы активируете её, она начинает подпрыгивать и вращаться, словно одержимая, пока, наконец, не взрывается в эффектном фейерверке.
                                           ---
