...
public class Hammer : Item
{
    ...
    public override string Description =>
        $"""
         Молоток - это ваш верный спутник в этом запутанном лабиринте, ваш личный инструмент разрушения. 
         Представьте себе, как вы с грохотом и лязгом пробиваете себе путь сквозь стены, словно Гном-разрушитель, оставляя за собой груды обломков. 
         Этот массивный, тяжелый молоток кажется неуклюжим, но в ваших умелых руках он становится оружием, способным сокрушить любое препятствие.
         ---
         Особенности молотка:
         - Вы получаете целых {DefaultCount} штук, чтобы устроить настоящий разгром в лабиринте!
         - Необходимо сначала нажать клавишу активации, а затем шагнуть, чтобы обрушить свой гнев на очередную стену.
         - Каждый раз, когда вы используете молоток, он издает громкий, удовлетворяющий звук "бам!", который, говорят, можно услышать даже в самых дальних уголках лабиринта.
         ---
