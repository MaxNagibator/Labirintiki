...
public class WoolYarn : Item
{
    ...
    public override string Description => """
                                          Нить - это ваш верный спутник в этом запутанном лабиринте, ваша ниточка Ариадны, 
                                          ведущая вас сквозь этот лабиринтный хаос. Представьте себе, как вы разматываете этот клубок шерстяной пряжи, 
                                          оставляя за собой яркий красный след, словно паук, плетущий свою паутину. Когда вы активируете нить, 
                                          она начинает светиться и пульсировать, словно живое существо, указывая вам путь к выходу и отмечая ваш маршрут.
                                          ---
                                          Особенности нити:
                                          - Нить настолько бесценна, что её нужной найти в темных уголках. Используйте её с умом,
                                           чтобы не заблудиться в этом лабиринте.
